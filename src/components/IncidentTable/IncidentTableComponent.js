    ...
    return (
      <div>
              ...
              <Col xs="auto">
                ...
                <Form.Group>
                  <ButtonGroup>
                    ...
                    <Button variant="outline-primary">P1</Button>
                    <Button variant="outline-primary">P2</Button>
                    <Button variant="outline-primary">P3</Button>
                    <Button variant="outline-primary">P4</Button>
                    <Button variant="outline-primary">P5</Button>
              ...
              <Col xs="auto">
                ...
                <Form.Group>
                  <ButtonGroup>
                    ...
                    <Button variant="outline-primary">High</Button>
                    <Button variant="outline-primary">Low</Button>
                  </ButtonGroup>
                </Form.Group>
              </Col>
            </Row>
        ...
        <div className="incidents-table-actions">
          <Container fluid>
            <Row>
              <Button variant="outline-dark">Acknowledge</Button>&nbsp;
              <Button variant="outline-dark">Escalate</Button>&nbsp;
              <Button variant="outline-dark">Reassign</Button>&nbsp;
              <Button variant="outline-dark">Snooze</Button>&nbsp;
              <Button variant="outline-dark">Resolve</Button>&nbsp;
              <Button variant="outline-dark">Update Priority</Button>&nbsp;
              <Button variant="outline-dark">Add Note</Button>&nbsp;
              <Button variant="outline-dark">Run Action</Button>
            </Row>
          </Container>
        </div>
        <br />
