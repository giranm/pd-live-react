...
export const UPDATE_QUERY_SETTING_SINCE_DATE_REQUESTED =
  'UPDATE_QUERY_SETTING_SINCE_DATE_REQUESTED';
export const UPDATE_QUERY_SETTING_SINCE_DATE_COMPLETED =
  'UPDATE_QUERY_SETTING_SINCE_DATE_COMPLETED';

export const UPDATE_QUERY_SETTING_INCIDENT_STATUS_REQUESTED =
  'UPDATE_QUERY_SETTING_INCIDENT_STATUS_REQUESTED';
export const UPDATE_QUERY_SETTING_INCIDENT_STATUS_COMPLETED =
  'UPDATE_QUERY_SETTING_INCIDENT_STATUS_COMPLETED';

export const UPDATE_QUERY_SETTING_INCIDENT_URGENCY_REQUESTED =
  'UPDATE_QUERY_SETTING_INCIDENT_URGENCY_REQUESTED';
export const UPDATE_QUERY_SETTING_INCIDENT_URGENCY_COMPLETED =
  'UPDATE_QUERY_SETTING_INCIDENT_URGENCY_COMPLETED';

export const UPDATE_QUERY_SETTING_INCIDENT_PRIORITY_REQUESTED =
  'UPDATE_QUERY_SETTING_INCIDENT_PRIORITY_REQUESTED';
export const UPDATE_QUERY_SETTING_INCIDENT_PRIORITY_COMPLETED =
